...
#sudo 
apt install -y brightnessctl evtest i2c-tools python3 python3-numpy python3-pyaudio python3-libevdev git
...
#sudo 
mkdir -p /etc/zenlights

# Move scripts to the appropriate directories
echo "Moving scripts..."
#sudo 
mv zenlights /usr/local/bin/
#sudo 
chmod +x /usr/local/bin/zenlights
#sudo 
mv dance.sh kbvis.py pulse.sh autobacklight.sh spaz.sh /etc/zenlights/
#sudo 
chmod +x /etc/zenlights/*.sh
